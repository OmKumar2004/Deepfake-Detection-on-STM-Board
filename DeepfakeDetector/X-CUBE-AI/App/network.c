...
#define AI_NETWORK_MODEL_SIGNATURE     "0x499e41b5b85c5874dd103638f4f86abc"
...
#define AI_TOOLS_DATE_TIME   "2025-04-16T05:05:10+0530"
...
/* Array#14 */
AI_ARRAY_OBJ_DECLARE(
  transpose_15_output_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 256, AI_STATIC)
...
/* Array#17 */
AI_ARRAY_OBJ_DECLARE(
  gemm_18_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Array#33 */
AI_ARRAY_OBJ_DECLARE(
  conv2d_12_scratch1_array, AI_ARRAY_FORMAT_FLOAT,
  NULL, NULL, 512, AI_STATIC)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, &conv2d_12_scratch1_array, NULL)
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 64, 2), AI_STRIDE_INIT(4, 4, 4, 16, 1024),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x0,
  AI_SHAPE_INIT(4, 3, 3, 3, 4), AI_STRIDE_INIT(4, 4, 12, 48, 144),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  21, 0x0,
  AI_SHAPE_INIT(4, 1, 3, 66, 66), AI_STRIDE_INIT(4, 4, 4, 12, 792),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  22, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 18, 18), AI_STRIDE_INIT(4, 4, 4, 32, 576),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  23, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 34, 34), AI_STRIDE_INIT(4, 4, 4, 16, 544),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  30, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 64, 3), AI_STRIDE_INIT(4, 4, 4, 256, 16384),
...
/* Tensor #32 */
AI_TENSOR_OBJ_DECLARE(
  transpose_15_output, AI_STATIC,
  32, 0x0,
  AI_SHAPE_INIT(4, 1, 4, 4, 16), AI_STRIDE_INIT(4, 4, 4, 16, 64),
  1, &transpose_15_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &transpose_15_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &reduce_16_output),
  AI_TENSOR_LIST_OBJ_EMPTY,
  AI_TENSOR_LIST_OBJ_EMPTY
)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  transpose_15_chain, AI_STATIC_CONST, 4,
...
AI_LAYER_OBJ_DECLARE(
  ...
  pool, forward_mp,
  &pool_14_chain,
  NULL, &transpose_15_layer, AI_STATIC, 
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 6448, 1, 1),
    6448, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 104544, 1, 1),
    104544, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &gemm_18_output),
  &in_pad_0_layer, 0x1b4262cc, NULL)
