...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "student_model_tiny"
...
#define AI_NETWORK_IN_1_HEIGHT      (3)
#define AI_NETWORK_IN_1_WIDTH       (64)
#define AI_NETWORK_IN_1_CHANNEL     (64)
#define AI_NETWORK_IN_1_SIZE        (12288)
